...
library(ggplot2)
library(dplyr)
library(patchwork) #used for the visual comparison of two graphs
library(car) #used to determine data set validity for the use of linear regression
library(ggrepel)
...
hist_electricity <- ggplot(final_dataset_end_HDI, aes(x = total_generation__twh)) + 
